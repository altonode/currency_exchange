...
MIGRATION_MODULES = {"sites": "currency_exchange.contrib.sites.migrations"}
...
TEMPLATES = [
    {
        ...
        "OPTIONS": {
            ...
            "context_processors": [
                ...
                "currency_exchange.utils.context_processors.settings_context",
            ],
        },
    }
]
...
ADMINS = [("""Antony Odhiambo""", "info@acesphere.cloud")]
